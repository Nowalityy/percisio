      ...
      <main className="pt-24 pb-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Percisio (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to
              protecting the privacy and security of your personal information and protected health
              information (PHI). This Privacy Policy explains how we collect, use, disclose, and
              safeguard your information when you use our medical assistance platform and related
              services.
            </p>
            <p>
              This Privacy Policy applies to all users of Percisio&apos;s services, including
              healthcare professionals, medical institutions, and patients whose data may be
            ...
            <ul>
              <li>
                <strong>Account Information:</strong> Name, email address, professional credentials,
                institutional affiliation, and contact information
              </li>
              <li>
                <strong>Professional Information:</strong> Medical license numbers, specialty areas,
              ...
              <li>
                ...
                including login times, feature usage, and system performance data
              </li>
              <li>
                <strong>Communication Data:</strong> Records of communications with our support
                team, feedback, and service requests
              </li>
            </ul>

            <h3 className="mt-8 mb-4">2.2 Protected Health Information (PHI)</h3>
            <p>
              In the course of providing our medical assistance services, we may process PHI,
              including:
            </p>
            <ul>
            ...
            <p>
              <strong>HIPAA Compliance:</strong> Percisio is designed to comply with the Health
              Insurance Portability and Accountability Act (HIPAA) and other applicable healthcare
              privacy regulations. We implement appropriate administrative, physical, and technical
            ...
            <ul>
              <li>
                <strong>Administrative Safeguards:</strong> Comprehensive privacy policies, staff
                training, and access controls
              </li>
              <li>
                <strong>Physical Safeguards:</strong> Secure data centers, access controls, and
                environmental protections
              </li>
              <li>
                <strong>Technical Safeguards:</strong> Encryption, secure transmission, access
            ...
            <p>
              When required, we enter into Business Associate Agreements (BAAs) with covered
              entities to ensure proper handling of PHI in accordance with HIPAA requirements.
            </p>
            ...
            <p>
              We do not sell, rent, or trade your personal information or PHI. We may share
            ...
            <ul>
              ...
              <li>
                <strong>Emergency Situations:</strong> To protect the health and safety of
            ...
            <p>
              We may share de-identified, aggregated data that cannot be used to identify
              individuals for research, analytics, and improvement purposes.
            </p>
            ...
            <ul>
              <li>
                <strong>Encryption:</strong> End-to-end encryption for data in transit and at rest
              </li>
              <li>
              ...
              <li>
                <strong>Network Security:</strong> Firewalls, intrusion detection, and secure
            ...
            <ul>
              <li>
                <strong>Account Information:</strong> Retained while your account is active and for
                a reasonable period thereafter
              </li>
              <li>
                <strong>PHI:</strong> Retained in accordance with applicable healthcare regulations
                and institutional requirements
              </li>
              <li>
                <strong>Technical Data:</strong> Retained for system maintenance and security
                purposes
              </li>
              <li>
            ...
            <p>
              ...
              However, this may affect your ability to use certain features of our platform.
            </p>
            ...
            <p>
              ...
              are in place for such transfers, including standard contractual clauses and adequacy
              decisions where applicable.
            </p>

            <h2 className="mt-12 mb-6">10. Children&apos;s Privacy</h2>
            <p>
              Our services are not intended for use by children under 13 years of age. We do not
            ...
            <p>
              If you believe we have violated your privacy rights, you may file a complaint with us
              or with the appropriate regulatory authority in your jurisdiction. We will investigate
              all complaints promptly and take appropriate corrective action.
            </p>
          </div>
        </div>
      </main>
